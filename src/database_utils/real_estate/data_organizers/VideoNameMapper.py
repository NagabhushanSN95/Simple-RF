...
def demo1():
    root_dirpath = Path('../../../../data/databases/RealEstate10K/data')
    unzipped_dirpath = root_dirpath / 'raw/unzipped_data/RealEstate10K'
    database_dirpath = root_dirpath / 'test/database_data'
