...
def demo1():
    ...
    avg_srocc = start_qa(pred_videos_dirpath, gt_depth_dirpath, frames_data_path, pred_depths_dirname,
                         downsampling_factor)
    return avg_srocc
...
def demo2(args: dict):
    ...
    avg_srocc = start_qa(pred_videos_dirpath, gt_depth_dirpath, frames_datapath, pred_depths_dirname, downsampling_factor)
    return avg_srocc
