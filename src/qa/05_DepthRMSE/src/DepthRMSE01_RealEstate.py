...
def start_qa(pred_videos_dirpath: Path, gt_depth_dirpath: Path, frames_datapath: Path, pred_depths_dirname: str,
    ...
    mse_computer = DepthRMSE(frames_data)
    avg_rmse, rmse_data = mse_computer.compute_avg_rmse(rmse_data, gt_depth_dirpath, pred_videos_dirpath,
...
def demo1():
    ...
    avg_rmse = start_qa(pred_videos_dirpath, gt_depth_dirpath, frames_data_path, pred_depths_dirname,
                        downsampling_factor)
    return avg_rmse
...
def demo2(args: dict):
    ...
    avg_rmse = start_qa(pred_videos_dirpath, gt_depth_dirpath, frames_datapath, pred_depths_dirname, downsampling_factor)
    return avg_rmse
