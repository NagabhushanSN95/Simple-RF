...
def start_qa(pred_videos_dirpath: Path, gt_depth_dirpath: Path, frames_datapath: Path, pred_depths_dirname: str,
    ...
    avg_mae, mae_data = mse_computer.compute_avg_mae(mae_data, gt_depth_dirpath, pred_videos_dirpath,
                                                       pred_depths_dirname, downsampling_factor)
...
def demo1():
    ...
    avg_mae = start_qa(pred_videos_dirpath, gt_depth_dirpath, frames_data_path, pred_depths_dirname,
                       downsampling_factor)
    return avg_mae
...
def demo2(args: dict):
    ...
    avg_mae = start_qa(pred_videos_dirpath, gt_depth_dirpath, frames_datapath, pred_depths_dirname, downsampling_factor)
    return avg_mae
