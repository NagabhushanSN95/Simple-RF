...
class DepthRMSE:
    ...
    def compute_avg_rmse(self, old_data: pandas.DataFrame, gt_depth_dirpath: Path, pred_videos_dirpath: Path,
                         database_dirpath: Path, pred_depths_dirname: str, resolution_suffix: str,
...
def start_qa(pred_videos_dirpath: Path, gt_depth_dirpath: Path, database_dirpath: Path, frames_datapath: Path,
    ...
    avg_rmse, rmse_data = rmse_computer.compute_avg_rmse(rmse_data, gt_depth_dirpath, pred_videos_dirpath, database_dirpath,
...
def demo1():
    ...
    avg_rmse = start_qa(pred_videos_dirpath, gt_depth_dirpath, database_dirpath, frames_data_path, pred_depths_dirname, resolution_suffix,
