...
def start_qa(pred_videos_dirpath: Path, gt_depth_dirpath: Path, database_dirpath: Path, frames_datapath: Path,
    ...
    avg_mae, mae_data = mae_computer.compute_avg_mae(mae_data, gt_depth_dirpath, pred_videos_dirpath,
...
def demo1():
    ...
    avg_mae = start_qa(pred_videos_dirpath, gt_depth_dirpath, database_dirpath, frames_data_path, pred_depths_dirname,
