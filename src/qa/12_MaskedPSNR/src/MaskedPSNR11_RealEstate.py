...
def demo1():
    ...
    avg_psnr = start_qa(pred_videos_dirpath, database_dirpath, frames_data_path, pred_frames_dirname,
...
def demo2(args: dict):
    ...
    avg_psnr = start_qa(pred_videos_dirpath, database_dirpath, frames_datapath, pred_frames_dirname,
                        downsampling_factor, mask_folder_name)
    return avg_psnr
