...
def run_all_qa(pred_videos_dirpath: Path, database_dirpath: Path, gt_depth_dirpath: Path, frames_datapath: Path,
    ...
    frame_metric_filepaths = [
        ...
        this_filepath.parent / '../../11_MaskedRMSE/src/MaskedRMSE12_NeRF_LLFF.py',
        this_filepath.parent / '../../12_MaskedPSNR/src/MaskedPSNR12_NeRF_LLFF.py',
        ...
        this_filepath.parent / '../../17_MaskedDepthMAE/src/MaskedDepthMAE32_NeRF_LLFF.py',
        this_filepath.parent / '../../19_MaskedDepthSROCC/src/MaskedDepthSROCC12_NeRF_LLFF.py',
    ]
...
def demo1():
    ...
    gt_depth_dirpath = root_dirpath / 'data/dense_input_radiance_fields/NeRF/runs/testing/test1001'
