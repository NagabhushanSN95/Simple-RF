...
def start_qa(pred_videos_dirpath: Path, database_dirpath: Path, frames_datapath: Path, pred_frames_dirname: str, downsampling_factor: int):
    ...
    avg_ssim, ssim_data = mse_computer.compute_avg_ssim(ssim_data, database_dirpath, pred_videos_dirpath, pred_frames_dirname, downsampling_factor)
...
def demo1():
    ...
    avg_ssim = start_qa(pred_videos_dirpath, database_dirpath, frames_data_path, pred_frames_dirname, downsampling_factor)
    return avg_ssim
...
def demo2(args: dict):
    ...
    avg_ssim = start_qa(pred_videos_dirpath, database_dirpath, frames_datapath, pred_frames_dirname, downsampling_factor)
    return avg_ssim
