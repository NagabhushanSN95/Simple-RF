...
class LossComputer:
    ...
    def compute_losses(self, input_dict, output_dict, model, return_loss_maps: bool = False):
        ...
        for loss_name in self.losses.keys():
            ...
            loss_dict = loss_obj.compute_loss(input_dict, output_dict, model, return_loss_maps=return_loss_maps)
